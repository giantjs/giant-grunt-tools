(function () {
    ...
    test("Task addition", function () {
        var config = $gruntTools.GruntConfig.create(),
    ...
    test("Getting alias tasks grouped by target", function () {
        ...
        ok(result.isA($gruntTools.GruntTaskCollection), "should return GruntTaskCollection instance");
        deepEqual(result.items, {
    ...
    test("Merging with other config", function () {
        var tasks = $gruntTools.MultiTaskCollection.create(),
            configA = $gruntTools.GruntConfig.create({
                copy  : {
                    dev : {foo: "baz"},
                    prod: {hello: "all"}
                },
        ...
        ok(configMerged.isA($gruntTools.GruntConfig), "should return GruntConfig instance");
