(function () {
    ...
    test("Instantiation with object", function () {
        throws(function () {
            $gruntTools.MultiTask.create('foo', 'bar');
        ...
        task = $gruntTools.MultiTask.create('foo');
        deepEqual(task.configNode, {}, "should set configNode property to empty object");

        task = $gruntTools.MultiTask.create('foo', configNode);
    ...
    test("Instantiation with function", function () {
        var task = $gruntTools.MultiTask.create('foo', genConfigNode);
    ...
    test("Conversion from string", function () {
        ...
        ok(multiTask.isA($gruntTools.MultiTask), "should return MultiTask instance");
    ...
    test("Setting package name", function () {
        ...
        ok(task.gruntPlugin.isA($gruntTools.GruntPlugin), "should set a GruntPlugin instance");
    ...
    test("Addition to config", function () {
        ...
        var task = 'foo'.toMultiTask({
            ...
            config = $gruntTools.GruntConfig.create();
    ...
    test("Adding to collection", function () {
        ...
        var task = 'foo'.toMultiTask(),
            collection = $gruntTools.MultiTaskCollection.create();
