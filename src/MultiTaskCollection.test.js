...
(function () {
    ...
    test("Conversion from Array", function () {
        ...
        ok(tasks.isA($gruntTools.MultiTaskCollection), "should return MultiTaskCollection instance");
        deepEqual(
            tasks.items,
            [1, 2, 3],
    ...
    test("Conversion to GruntConfig", function () {
        ...
        ok(config.isA($gruntTools.GruntConfig), "should return GruntConfig instance");
